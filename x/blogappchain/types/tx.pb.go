...
// source: blogappchain/blogappchain/tx.proto
...
func (*MsgCreatePost) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f9f16379221c5d, []int{0}
}
...
func (*MsgCreatePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f9f16379221c5d, []int{1}
}
...
func (*MsgUpdatePost) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f9f16379221c5d, []int{2}
}
...
func (*MsgUpdatePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f9f16379221c5d, []int{3}
}
...
func (*MsgDeletePost) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f9f16379221c5d, []int{4}
}
...
func (*MsgDeletePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f9f16379221c5d, []int{5}
}
...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "blogappchain.blogappchain.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "blogappchain.blogappchain.MsgCreatePostResponse")
	proto.RegisterType((*MsgUpdatePost)(nil), "blogappchain.blogappchain.MsgUpdatePost")
	proto.RegisterType((*MsgUpdatePostResponse)(nil), "blogappchain.blogappchain.MsgUpdatePostResponse")
	proto.RegisterType((*MsgDeletePost)(nil), "blogappchain.blogappchain.MsgDeletePost")
	proto.RegisterType((*MsgDeletePostResponse)(nil), "blogappchain.blogappchain.MsgDeletePostResponse")
}

func init() {
	proto.RegisterFile("blogappchain/blogappchain/tx.proto", fileDescriptor_e0f9f16379221c5d)
}

var fileDescriptor_e0f9f16379221c5d = []byte{
	// 294 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blogappchain.blogappchain.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdatePost(ctx context.Context, in *MsgUpdatePost, opts ...grpc.CallOption) (*MsgUpdatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blogappchain.blogappchain.Msg/UpdatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeletePost(ctx context.Context, in *MsgDeletePost, opts ...grpc.CallOption) (*MsgDeletePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blogappchain.blogappchain.Msg/DeletePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blogappchain.blogappchain.Msg/CreatePost",
	}
...
func _Msg_UpdatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blogappchain.blogappchain.Msg/UpdatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeletePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blogappchain.blogappchain.Msg/DeletePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "blogappchain.blogappchain.Msg",
	...
	Metadata: "blogappchain/blogappchain/tx.proto",
}
